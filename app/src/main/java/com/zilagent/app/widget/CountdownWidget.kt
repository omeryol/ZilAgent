...
class CountdownWidget : AppWidgetProvider() {
    ...
    companion object {
        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            val flow = WidgetStore.getWidgetFlowDirection(context) // 0:V, 1:H
            val order = WidgetStore.getWidgetElementOrder(context) // 0:TimeFirst, 1:LabelFirst
            ...
            // Apply spacing to the second element
            ...
            // Reset margins first to avoid conflicts
        ...
        fun updateAllWidgets(context: Context) {
            ...
            val appWidgetIds = appWidgetManager.getAppWidgetIds(ComponentName(context, CountdownWidget::class.java))
            for (appWidgetId in appWidgetIds) updateAppWidget(context, appWidgetManager, appWidgetId)
        }
    }
}
